    ...
    if (language === "ko") {
      return (
        <>
          ...
          >
            <span className="text-white text-2xl sm:text-3xl md:text-4xl">
              <span className="text-indigo-500">김현상</span> 입니다.
            </span>
          </div>
        </>
      );
      ...
      return (
        <>
          ...
          >
            <span className="text-indigo-500 text-2xl sm:text-3xl md:text-4xl">
              Hyeonsang Kim
            </span>
          </div>
          <div
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 flex flex-col justify-center items-center text-center">
        ...
        >
          <Link
            ...
            smooth={true}
            duration={500}
            className="inline-block border-2 px-6 py-2 border-indigo-500 transform transition-transform duration-300 hover:scale-105 cursor-pointer"
          >
